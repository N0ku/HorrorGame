...
public class ProceduralGenerator : MonoBehaviour
{
    ...
    [Header("Configuration de l'�tage (Selectionner l'�tage)")]
    [SerializeField] private EtageType etageType = EtageType.Creator;
    [Space(15)]


    [Header("Configuration �tage 1")]
    ...
    void PlaceRandomObjects(MapSize room)
    {
            ...
            switch (i)
            {
                case 1:
                    ...
                    else
                    {
                        ...
                        {
                            Debug.Log("Arr�t de la g�n�ration en raison du nombre maximum d'essais atteint.");
                            break;
                        }
                    }
                    break;
        ...
        for (int i = 3; i < numberOfRoom; i++)
        {
            ...
            // R�cup�re la taille du prefab et les cellules occup�es par le prefab
    ...
    {
        // Ajoutez la logique pour v�rifier si le placement du prefab est possible dans la cellule de d�part
        for (int x = startCell.x; x < startCell.x + prefabSize.x / wallSpacing; x++)
        {
            for (int y = startCell.y; y < startCell.y + prefabSize.z / wallSpacing; y++)
            {
                ...
                {
                    Debug.Log("En Dehors de la grille ou d�j� occup�");
                    return false;
                }
            }
        }
